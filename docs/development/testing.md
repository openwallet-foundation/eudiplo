...
To avoid very slow failures or flaky waits, calibrate OIDF polling thresholds from measured timings. See
[apps/backend/test/oidf/README.md](../../apps/backend/test/oidf/README.md).
