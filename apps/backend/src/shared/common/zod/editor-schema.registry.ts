...
import { statusListEditorSchemaBundle } from "../../../issuer/lifecycle/status/dto/status-list-editor-schema.bundle";
...
import { webhookEditorSchemaBundle } from "../../utils/webhook/webhook-editor-schema.bundle";
import type { EditorSchemaBundle } from "./editor-schema";
