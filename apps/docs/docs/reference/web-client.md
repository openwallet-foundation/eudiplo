...
After completing the [Quick Start setup](../getting-started/quick-start.md):
...
:::warning[Important]
Change the default credentials before using EUDIPLO in production. See [Authentication](../administration/authentication.md) for details.
:::
