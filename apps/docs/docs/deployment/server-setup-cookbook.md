...
[`eudiplo demo`](../getting-started/quick-start.md) instead.
...
More details are available in the [Docker Compose deployment guide](./docker-compose.md),
[configuration model guide](../architecture/configuration-model.md), and
