...
export const ServiceInfoResponseDtoSchema = {
    type: 'object',
    properties: {
        service: {
            type: 'string',
...
export const Oid4VpAuthorizationServerConfigSchema = {
    ...
    properties: {
        ...
        walletAttestationRequired: {
            type: 'boolean',
            description: 'Require wallet attestation for requests to this authorization server. Omit to inherit the issuance default.'
        },
